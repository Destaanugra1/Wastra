...
const ErrorPage = () => {
  return (
    <>
      <Navbar />
      <section className='bg-gradient-to-br from-gray-50 via-blue-50 to-indigo-100'>
        <div className='container min-h-screen px-6 py-12 mx-auto lg:flex lg:items-center lg:gap-12'>
          <div className='wf-ull lg:w-1/2'>
            ...
            <div className='flex items-center mt-6 gap-x-3'>
              <Link to='/' className='flex items-center justify-center w-1/2 px-5 py-2 text-sm text-gray-700 transition-colors duration-200 bg-white border rounded-lg gap-x-2 sm:w-auto hover:bg-gray-100 border-gray-300'>
                <svg
