...
const DetailProduct = () => {
    ...
    if (snapToken) {
      ...
      window.snap.pay(snapToken, {
        ...
        onPending: (result) => {
          ...
          // Jika ingin redirect ke halaman produk, bisa tambahkan: navigate('/');
        },
        onError: (result) => {
          setPaymentMessage(
        ...
        onClose: async () => {
          // Treat closing as a cancellation
          setPaymentSuccess(false);
    ...
    if (snapToken && window.snap) {
      ...
      window.snap.pay(snapToken, {
        ...
        onClose: async () => {
          ...
          if (orderId) {
            setPaymentMessage(
              'Anda membatalkan pembayaran. Klik "Lanjutkan Pembayaran" untuk mencoba lagi.'
            );
          } else {
            setPaymentMessage(
              'Anda membatalkan pembayaran. Klik "Beli Sekarang" untuk mencoba lagi.'
  ...
  }, [snapToken, product, quantity, orderId, updateProductStock, VITE_API_URL]);
