                ...
                <div className='text-center py-12'>
                  ...
                  <p className='mt-1 text-sm text-gray-500'>
                    {searchTerm
                      ...
                      : 'Mulai berbelanja untuk melihat riwayat'}
                  </p>
                </div>
              ) : (
                        ...
                        {items.length > 0 && (
                          <details className='group'>
                            <summary className='cursor-pointer text-sm text-blue-600 hover:text-blue-800 font-medium flex items-center'>
                              ...
                              <svg
                                className='ml-1 h-4 w-4 transform group-open:rotate-180 transition-transform'
                                fill='none'
                                stroke='currentColor'
                                viewBox='0 0 24 24'>
                                <path
              ...
              {totalPages > 1 && (
                <div className='flex items-center justify-between mt-6 pt-4 border-t border-gray-200'>
                  <div className='text-sm text-gray-700'>
                    ...
                    dari {filteredHistory.length} hasil
                  </div>
